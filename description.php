                    ...
                    <div class="destination_info">
				        ...
				        <h3 class="mb-40">Description</h3>
                            ...
                            <div class="form-group mt-3">
                                <a href="addpackage.php?data=<?php echo $row->_id;?>" class="genric-btn danger circle arrow">Book</a>
                            </div></center>
					</div>
				</div>
			</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <a href="description.php?data=<?=$row->_id?>"><img src="upload/<?php echo $a;?>" alt="" style="width:300px;height:200px;"></a><?php
                        ...
                        <div class="place_info">
                            <a href="description.php?data=<?=$row->_id?>"><h3><?php echo $row->pkg_name ?></h3></a>
